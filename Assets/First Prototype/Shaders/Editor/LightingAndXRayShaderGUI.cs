...
public class LightingAndXRayShaderGUI : ShaderGUI
{
	...
	private void DoMain()
	{
        ...
        //xRay option
        MaterialProperty xRayEdgeColor = FindProperty ( "_XRayEdgeColor" );
        EditorGUI.indentLevel += 2;
        editor.ColorProperty ( xRayEdgeColor, "X-Ray Edge Color" );
        EditorGUI.indentLevel -= 2;
	...
	private void DoEmission()
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			editor.TexturePropertyWithHDRColor(
                ...
                map,
                FindProperty ( "_Emission" ),//tex ? FindProperty("_Emission") : null, 
                emissionConfig, 
                false);
        }
		if(EditorGUI.EndChangeCheck() && tex != map.textureValue)
